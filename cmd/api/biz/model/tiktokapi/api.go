...
type UserInfoRequest struct {
	UserID string `thrift:"user_id,1" json:"user_id" query:"user_id" vd:"len($) >= 0"`
...
type FeedService interface {
	GetVedioList(ctx context.Context, request *FeedRequest) (r *FeedResponse, err error)
}
...
func (p *FeedServiceClient) GetVedioList(ctx context.Context, request *FeedRequest) (r *FeedResponse, err error) {
	var _args FeedServiceGetVedioListArgs
	_args.Request = request
	var _result FeedServiceGetVedioListResult
	if err = p.Client_().Call(ctx, "GetVedioList", &_args, &_result); err != nil {
		return
	}
...
type UserService interface {
	UserRegist(ctx context.Context, request *RegisterRequest) (r *RegisterResponse, err error)
...
func (p *UserServiceClient) UserRegist(ctx context.Context, request *RegisterRequest) (r *RegisterResponse, err error) {
	var _args UserServiceUserRegistArgs
	_args.Request = request
	var _result UserServiceUserRegistResult
	if err = p.Client_().Call(ctx, "UserRegist", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
...
func NewFeedServiceProcessor(handler FeedService) *FeedServiceProcessor {
	...
	self.AddToProcessorMap("GetVedioList", &feedServiceProcessorGetVedioList{handler: handler})
	return self
}
...
type feedServiceProcessorGetVedioList struct {
	handler FeedService
}

func (p *feedServiceProcessorGetVedioList) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := FeedServiceGetVedioListArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("GetVedioList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := FeedServiceGetVedioListResult{}
	var retval *FeedResponse
	if retval, err2 = p.handler.GetVedioList(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing GetVedioList: "+err2.Error())
		oprot.WriteMessageBegin("GetVedioList", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("GetVedioList", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
...
type FeedServiceGetVedioListArgs struct {
	Request *FeedRequest `thrift:"request,1"`
}

func NewFeedServiceGetVedioListArgs() *FeedServiceGetVedioListArgs {
	return &FeedServiceGetVedioListArgs{}
}

var FeedServiceGetVedioListArgs_Request_DEFAULT *FeedRequest

func (p *FeedServiceGetVedioListArgs) GetRequest() (v *FeedRequest) {
	if !p.IsSetRequest() {
		return FeedServiceGetVedioListArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_FeedServiceGetVedioListArgs = map[int16]string{
	1: "request",
}

func (p *FeedServiceGetVedioListArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *FeedServiceGetVedioListArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceGetVedioListArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceGetVedioListArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *FeedServiceGetVedioListArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetVedioList_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *FeedServiceGetVedioListArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *FeedServiceGetVedioListArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceGetVedioListArgs(%+v)", *p)
}

type FeedServiceGetVedioListResult struct {
	Success *FeedResponse `thrift:"success,0,optional"`
}

func NewFeedServiceGetVedioListResult() *FeedServiceGetVedioListResult {
	return &FeedServiceGetVedioListResult{}
}

var FeedServiceGetVedioListResult_Success_DEFAULT *FeedResponse

func (p *FeedServiceGetVedioListResult) GetSuccess() (v *FeedResponse) {
	if !p.IsSetSuccess() {
		return FeedServiceGetVedioListResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_FeedServiceGetVedioListResult = map[int16]string{
	0: "success",
}

func (p *FeedServiceGetVedioListResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *FeedServiceGetVedioListResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_FeedServiceGetVedioListResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *FeedServiceGetVedioListResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *FeedServiceGetVedioListResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("GetVedioList_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
...
func (p *FeedServiceGetVedioListResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *FeedServiceGetVedioListResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("FeedServiceGetVedioListResult(%+v)", *p)
}
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("UserRegist", &userServiceProcessorUserRegist{handler: handler})
...
type userServiceProcessorUserRegist struct {
	handler UserService
}

func (p *userServiceProcessorUserRegist) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceUserRegistArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
		oprot.WriteMessageBegin("UserRegist", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
		return false, err
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceUserRegistResult{}
	var retval *RegisterResponse
	if retval, err2 = p.handler.UserRegist(ctx, args.Request); err2 != nil {
		x := thrift.NewTApplicationException(thrift.INTERNAL_ERROR, "Internal error processing UserRegist: "+err2.Error())
		oprot.WriteMessageBegin("UserRegist", thrift.EXCEPTION, seqId)
		x.Write(oprot)
		oprot.WriteMessageEnd()
		oprot.Flush(ctx)
	...
	if err2 = oprot.WriteMessageBegin("UserRegist", thrift.REPLY, seqId); err2 != nil {
		err = err2
	}
	if err2 = result.Write(oprot); err == nil && err2 != nil {
		err = err2
...
type UserServiceUserRegistArgs struct {
	Request *RegisterRequest `thrift:"request,1"`
}

func NewUserServiceUserRegistArgs() *UserServiceUserRegistArgs {
	return &UserServiceUserRegistArgs{}
}

var UserServiceUserRegistArgs_Request_DEFAULT *RegisterRequest

func (p *UserServiceUserRegistArgs) GetRequest() (v *RegisterRequest) {
	if !p.IsSetRequest() {
		return UserServiceUserRegistArgs_Request_DEFAULT
	}
	return p.Request
}

var fieldIDToName_UserServiceUserRegistArgs = map[int16]string{
	1: "request",
}

func (p *UserServiceUserRegistArgs) IsSetRequest() bool {
	return p.Request != nil
}

func (p *UserServiceUserRegistArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUserRegistArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUserRegistArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserServiceUserRegistArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UserRegist_args"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField1(oprot); err != nil {
...
func (p *UserServiceUserRegistArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("request", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Request.Write(oprot); err != nil {
...
func (p *UserServiceUserRegistArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUserRegistArgs(%+v)", *p)
}

type UserServiceUserRegistResult struct {
	Success *RegisterResponse `thrift:"success,0,optional"`
}

func NewUserServiceUserRegistResult() *UserServiceUserRegistResult {
	return &UserServiceUserRegistResult{}
}

var UserServiceUserRegistResult_Success_DEFAULT *RegisterResponse

func (p *UserServiceUserRegistResult) GetSuccess() (v *RegisterResponse) {
	if !p.IsSetSuccess() {
		return UserServiceUserRegistResult_Success_DEFAULT
	}
	return p.Success
}

var fieldIDToName_UserServiceUserRegistResult = map[int16]string{
	0: "success",
}

func (p *UserServiceUserRegistResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceUserRegistResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUserRegistResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUserRegistResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *UserServiceUserRegistResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
	if err = oprot.WriteStructBegin("UserRegist_result"); err != nil {
		goto WriteStructBeginError
	}
	if p != nil {
		if err = p.writeField0(oprot); err != nil {
...
func (p *UserServiceUserRegistResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceUserRegistResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUserRegistResult(%+v)", *p)
}
