...
type Client interface {
	CommentAction(ctx context.Context, request *comment.CommentRequest, callOptions ...callopt.Option) (r *comment.CommentResponse, err error)
...
func (p *kCommentServiceClient) CommentAction(ctx context.Context, request *comment.CommentRequest, callOptions ...callopt.Option) (r *comment.CommentResponse, err error) {
